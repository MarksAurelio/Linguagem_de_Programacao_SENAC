''' O objetivo desta atividade é criar uma interface gráfica de cadastro de usuários utilizando 
a biblioteca Tkinter, com integração ao banco de dados MySQL. 
O programa deverá permitir que o usuário insira seu nome e senha e, 
ao clicar no botão 'Cadastrar', esses dados sejam armazenados em uma tabela no banco de dados.  
Instalar a biblioteca: pip install mysql-connector-python
